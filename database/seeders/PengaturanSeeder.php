...
class PengaturanSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            ...
            [
                "slug" => Str::random(32),
                "keterangan" => "gudang.benang.barangkeluar.butuh.approval",
                "nilai" => "Tidak"
            ],
            [
                "slug" => Str::random(32),
                "keterangan" => "gudang.benang.barangmasuk.butuh.approval",
                "nilai" => "Tidak"
            ],
            [
                "slug" => Str::random(32),
                "keterangan" => "gudang.benang.retur.butuh.approval",
                "nilai" => "Tidak"
            ],
            [
                "slug" => Str::random(32),
                "keterangan" => "gudang.avalan.barangkeluar.butuh.approval",
                "nilai" => "Tidak"
            ],
            [
                "slug" => Str::random(32),
                "keterangan" => "gudang.avalan.barangmasuk.butuh.approval",
                "nilai" => "Tidak"
            ],
            [
                "slug" => Str::random(32),
                "keterangan" => "gudang.avalan.retur.butuh.approval",
                "nilai" => "Tidak"
            ],
            [
                "slug" => Str::random(32),
                "keterangan" => "gudang.packing.barangkeluar.butuh.approval",
                "nilai" => "Tidak"
            ],
            [
                "slug" => Str::random(32),
                "keterangan" => "gudang.packing.barangmasuk.butuh.approval",
                "nilai" => "Tidak"
            ],
            [
                "slug" => Str::random(32),
                "keterangan" => "gudang.packing.retur.butuh.approval",
                "nilai" => "Tidak"
            ],
        ];
