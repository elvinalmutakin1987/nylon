...
return new class extends Migration
{
    ...
    {
        Schema::create('laporansulzerdetails', function (Blueprint $table) {
            $table->id();
            $table->integer('laporansulzer_id')->nullable();
    ...
    {
        Schema::dropIfExists('laporansulzerdetails');
    }
};
