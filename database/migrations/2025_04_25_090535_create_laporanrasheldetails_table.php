...
return new class extends Migration
{
    ...
    {
        Schema::create('laporanrasheldetails', function (Blueprint $table) {
            $table->id();
            $table->integer('laporanrashel_id')->nullable();
    ...
    {
        Schema::dropIfExists('laporanrasheldetails');
    }
};
