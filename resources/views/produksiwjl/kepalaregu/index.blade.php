                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" Active>Kepala Regu</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                        ...
                        <form action="{{ route('produksiwjl.operator.store') }}" enctype="multipart/form-data"
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Kepala Regu WJL</h3>
                                </div>
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-md-12">
                                            <button type="button" class="btn btn-primary m-1" data-toggle="modal"
                                                ...
                                                Lihat Laporan Sebelumnya</button>
                                            <button type="button" class="btn btn-success m-1" data-toggle="modal"
                                                data-target="#modal-import" onclick="lihat_laporan_operator()"><i
                                                    class="fa fa-user"></i>
                                                Lihat Laporan Operator</button>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
...
@section('script')
    <script type="text/javascript">
        ...
        function lihat_laporan_sebelumnya() {
            $("#div-detail").html("");
            var url =
                '{!! route('produksiwjl.operator.get_detail', [
                    'mesin_id' => '_mesin',
                    'tanggal' => '_tanggal',
                    'shift' => '_shift',
                ]) !!}';
