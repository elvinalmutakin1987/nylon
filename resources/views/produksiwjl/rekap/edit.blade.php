                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('produksiwjl.rekap.index') }}">Rekap Produksi
                                    WJL</a></li>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <!-- Application buttons -->
                        <form action="{{ route('produksiwjl.rekap.update', $produksiwjl->slug) }}"
                            enctype="multipart/form-data" method="POST">
                            @csrf
                            @method('put')
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Produksi WJL</h3>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="mesin" value="{{ $mesin->nama }}" readonly>
                                                <input type="hidden" id="mesin_id" name="mesin_id"
                                                    value="{{ $produksiwjl->mesin_id }}">
                                                @error('mesin_id')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('meter_awal') ?? Number::format((float) $produksiwjl->meter_awal, precision: 1) }}"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('meter_akhir') ?? Number::format((float) $produksiwjl->meter_akhir, precision: 1) }}"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                @php
                                                    $hasil = $produksiwjl->meter_akhir - $produksiwjl->meter_awal;
                                                @endphp
                                                <input type="text"
                                                    class="form-control @error('hasil') is-invalid @enderror"
                                                    id="hasil" name="hasil"
                                                    value="{{ old('hasil') ?? Number::format((float) $hasil, precision: 1) }}"
                                                    readonly>
                                                @error('hasil')
                                                    <span id="hasil-error"
                                                        class="error invalid-feedback">{{ $message }}</span>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('keterangan') is-invalid @enderror" rows="10" id="keterangan"
                                                    name="keterangan">{!! nl2br($produksiwjl->keterangan) !!}</textarea>
                                                @error('keterangan')
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="lungsi" name="lungsi"
                                                    value="{{ old('lungsi') ?? Number::format((float) $produksiwjl->lungsi, precision: 1) }}"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="pakan" name="pakan"
                                                    value="{{ old('pakan') ?? $produksiwjl->pakan }}"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="lubang" name="lubang"
                                                    value="{{ old('lubang') ?? $produksiwjl->lubang }}">
                                                @error('lubang')
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="lebar" name="lebar"
                                                    value="{{ old('lebar') ?? Number::format((float) $produksiwjl->lebar, precision: 1) }}"
                                ...
                                <div class="card-footer">
                                    <a type="button" class="btn btn-default"
                                        href="{{ route('produksiwjl.rekap.index') }}"><i class="fa fa-reply"></i>
                                        Kembali</a>
