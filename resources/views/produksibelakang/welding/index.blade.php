                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" Active>Produksi Welding</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Produksi Welding</h3>
                            </div>
                            <div class="card-body">
                                <div class="row mb-4">
                                    <div class="col-md-12">
                                        <a type="button" class="btn btn-success m-1"
                                            href="{{ route('prodwelding.create') }}"><i class="fa fa-plus"></i> Tambah
                                            Data</a>
        ...
        function get_data() {
            table1.DataTable({
                ...
                "columns": [{
                    ...
                    {
                        data: 'nomor_laminating',
                        name: 'nomor_laminating',
                        orderable: true,
                        searchable: true
                    },
                    {
        ...
        function hapus(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = `{!! route('prodwelding.destroy', ':_id') !!}`;
