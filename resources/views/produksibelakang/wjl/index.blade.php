                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" Active>Produksi WJL</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Produksi WJL</h3>
                            </div>
                            <div class="card-body">
                                <div class="row mb-4">
                                    <div class="col-md-12">
                                        <a type="button" class="btn btn-success m-1"
                                            href="{{ route('prodwjl.create') }}"><i class="fa fa-plus"></i> Tambah
                                            Data</a>
        ...
        function hapus(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = `{!! route('prodwjl.destroy', ':_id') !!}`;
