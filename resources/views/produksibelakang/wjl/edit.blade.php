        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <!-- Application buttons -->
                        <form action="{{ route('prodwjl.update', $prodwjl->slug) }}" enctype="multipart/form-data"
                            method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('nomor_so') ?? $prodwjl->nomor_so }}">
                                                @error('nomor_so')
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <select
                                                    ...
                                                    <option value="{{ $prodwjl->mesin_id }}">{{ $prodwjl->mesin->nama }}
                                                    </option>
                                                </select>
                                                @error('mesin_id')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="div_tanggal" data-target-input="nearest">
                                                    <input type="text" class="form-control datetimepicker-input"
                                                        ...
                                                        value="{{ old('tanggal') ?? $prodwjl->tanggal }}" />
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('operator') ?? $prodwjl->operator }}">
                                                @error('operator')
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('keterangan') ?? $prodwjl->keterangan }}">
                                                @error('keterangan')
                                                ...
                                                <table id="table1" class="table projects table-bordered table-sm">
                                                    ...
                                                    <tbody>
                                                        @foreach ($prodwjl->prodwjldetail as $d)
                                                            ...
                                                            @endif
                                                        @endforeach
                                                        @if (count($prodwjl->prodwjldetail) == 0)
                                                            <tr>
                                                                <td style="vertical-align: top">
                                                                    <select
                                                                        class="form-control select2 w-100 select-material @error('mesin_id') is-invalid @enderror"
