        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <!-- Application buttons -->
                        <form action="{{ route('prodtarik.update', $prodtarik->slug) }}" enctype="multipart/form-data"
                            method="POST">
                            @csrf
                            @method('put')
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Produksi Tarik</h3>
                                </div>
                                <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="div_tanggal" data-target-input="nearest">
                                                    <input type="text" class="form-control datetimepicker-input"
                                                        ...
                                                        value="{{ old('tanggal') ?? $prodtarik->tanggal }}" />
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <select
                                                    ...
                                                    id="shift" name="shift">
                                                    <option value="Pagi"
                                                        {{ $prodtarik->shift == 'Pagi' ? 'selected' : '' }}>
                                                        Pagi</option>
                                                    <option value="Sore"
                                                        {{ $prodtarik->shift == 'Sore' ? 'selected' : '' }}>Sore</option>
                                                    <option value="Malam"
                                                        {{ $prodtarik->shift == 'Malam' ? 'selected' : '' }}>Malam</option>
                                                </select>
                                                @error('shift')
                                                    <span id="shift-error"
                                                        class="error invalid-feedback">{{ $message }}</span>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('operator') ?? $prodtarik->operator }}">
                                                @error('operator')
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('keterangan') ?? $prodtarik->keterangan }}">
                                                @error('keterangan')
                                                ...
                                                <table id="table1" class="table projects table-bordered table-sm">
                                                    ...
                                                    <tbody>
                                                        @foreach ($prodtarik->prodtarikdetail as $d)
                                                                ...
                                                                <tr>
                                                                    <td style="vertical-align: top">
                                                                        <select
                                                                            ...
                                                                            <option value="{{ $d->prodwelding_id }}">
                                                                                {{ $d->prodwelding->nomor }}</option>
                                                                        </select>
                                                                    </td>
                                                                    <td style="vertical-align: top">
                                                                        <input type="text"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="vertical-align: top">
                                                                        <input type="text"
                                                                            ...
                                                                            id="jumlah{{ $d->slug }}"
                                                                            name="jumlah[]"
                                                                            onkeyup="ubah_format('jumlah{{ $d->slug }}', this.value);"
                                                                            value="{{ $d->jumlah ? Number::format($d->jumlah) : '' }}">
                                                                    </td>
                                                                    <td style="vertical-align: top">
                                                                        <input type="text"
                                                                            ...
                                                                            id="jumlah2{{ $d->slug }}"
                                                                            name="jumlah2[]"
                                                                            onkeyup="ubah_format('jumlah2{{ $d->slug }}', this.value)"
                                                                            value="{{ $d->jumlah2 ? Number::format($d->jumlah2) : '' }}">
                                                                    </td>
                                                                    <td style="vertical-align: top" class="text-center">
                                                            ...
                                                            @endif
                                                        @endforeach
                                                        @if (count($prodtarik->prodtarikdetail) == 0)
                                                            <tr>
                                                                <td style="vertical-align: top">
                                                                    <select
                                                                        class="form-control select2 w-100 select-welding @error('prodwelding_id') is-invalid @enderror"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="div_tanggal_panen"
                                                    ...
                                                    <input type="text" class="form-control datetimepicker-input"
                                                        ...
                                                        name="tanggal_panen"
                                                        value="{{ old('tanggal_panen') ?? $prodtarik->tanggal_panen }}" />
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <select
                                                    ...
                                                    <option value="{{ $prodtarik->material_id }}">
                                                        {{ $prodtarik->material->nama }}</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ Number::format((float) $prodtarik->jumlah) }}">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ Number::format((float) $prodtarik->jumlah2) }}">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
