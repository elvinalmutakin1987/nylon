                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" Active>Rekap Laporan Pengeringan Kain</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Rekap Laporan Pengeringan Kain</h3>
                            </div>
                            <div class="card-body">
                                <div class="row mb-4">
                                    <div class="col-md-12">
...
@section('script')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var url =
                '{!! route('produksilaminating.rekap.get_rekap', [
        ...
        function cetak() {
            var url =
                '{!! route('produksilaminating.rekap.cetak', [
                    'tanggal_dari' => '_tanggal_dari',
                    'tanggal_sampai' => '_tanggal_sampai',
                    'mesin_id' => '_mesin_id',
                ]) !!}';
        ...
        function export_() {
            var url =
                '{!! route('produksilaminating.rekap.export', [
                    'tanggal_dari' => '_tanggal_dari',
                    'tanggal_sampai' => '_tanggal_sampai',
                    'mesin_id' => '_mesin_id',
                ]) !!}';
