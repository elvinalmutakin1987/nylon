                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" Active>Beam Naik</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <!-- Application buttons -->
                        <form action="{{ route('produksiextruder.stockbeaming.update', $stockbeaming->slug) }}"
                            enctype="multipart/form-data" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Beam Naik</h3>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control @error('operator') is-invalid @enderror" id="operator"
                                                name="operator" value="{{ old('operator') }}">
                                            @error('operator')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('meter') is-invalid @enderror"
                                                id="meter" name="meter" value="{{ old('meter') }}">
                                            @error('meter')
                                                <span id="meter-error" class="error invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="card-footer">
                                    <a type="button" class="btn btn-default"
                                        href="{{ route('produksiextruder.stockbeaming.index') }}"><i
                                            class="fa fa-reply"></i>
                                        Kembali</a>
