                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <select
                                                    class="form-control select2 w-100 select-posisi @error('posisi') is-invalid @enderror"
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    class="form-control @error('meter') is-invalid @enderror" id="meter"
                                                    name="meter" value="{{ old('meter') }}" required>
                                                @error('meter')
                                                    <span id="meter-error"
                                                        class="error invalid-feedback">{{ $message }}</span>
                                                @enderror
