                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Laporan Kontrol Reifen</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <button type="button" class="btn btn-success" data-toggle="modal"
                                            data-target="#modal-import" onclick="lihat_laporan_sebelumnya()"><i
                                                class="fa fa-plus"></i>
                                            Buat Laporan Kontrol Reifen</button>
                                    </div>
                                </div>
                            </div>
                            <!-- /.card-body -->
    ...
    <script type="text/javascript">
        ...
        function format_select2() {
            ...
            $('.select-jenis-benang').select2({
                ...
                allowClear: true,
                ajax: {
                    url: '{{ route('produksiextruder-kontrol-reifen.get_material') }}',
                    dataType: 'json',
        ...
        function lihat_laporan_sebelumnya() {
            var url =
                '{!! route('produksiextruder-kontrol-reifen.create', [
                    'tanggal' => '_tanggal',
                    'shift' => '_shift',
                ]) !!}';
