                                            ...
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ $laporansulzer_sebelumnya->tanggal }}" readonly>
                                                    @error('tanggal')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="shift" value="{{ $laporansulzer_sebelumnya->shift }}" readonly>
                                                @error('shift')
                                                    <span id="shift-error"
                                                        class="error invalid-feedback">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $laporansulzer_sebelumnya->mesin->nama }}" readonly>
                                                <input type="hidden" name="mesin_id" id="mesin_id"
                                                    value="{{ $laporansulzer_sebelumnya->mesin_id }}">
                                                @error('mesin_id')
                                                    <span id="shift-error"
                                                        class="error invalid-feedback">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $laporansulzer_sebelumnya->jenis_produksi }}" readonly>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <table id="table1" class="table projects table-bordered">
                                                ...
                                                <tbody>
                                                    @foreach ($laporansulzer_sebelumnya->laporansulzerdetail as $d)
                                                        <tr>
