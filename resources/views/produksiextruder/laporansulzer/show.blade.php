                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Serah Terima Laporan Sulzer</h3>
                            </div>
                            <div class="card-body">
                                @if ($laporansulzer_sebelumnya)
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ old('tanggal') ?? $laporansulzer_sebelumnya->tanggal }}"
                                                        readonly>
                                                    @error('tanggal')
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="shift"
                                                    value="{{ old('shift') ?? $laporansulzer_sebelumnya->shift }}" readonly>
                                                @error('shift')
                                                    <span id="shift-error"
                                                        class="error invalid-feedback">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('meter_awal') ?? Number::format($laporansulzer_sebelumnya->meter_awal, precision: 1) }}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('meter_akhir') ?? Number::format($laporansulzer_sebelumnya->meter_akhir, precision: 1) }}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="hasil"
                                                    value="{{ old('hasil') ?? Number::format($laporansulzer_sebelumnya->meter_akhir - $produksiwjl_sebelumnya->meter_awal, precision: 1) }}"
                                                    readonly>
                                                @error('hasil')
                                                    <span id="hasil-error"
                                                        class="error invalid-feedback">{{ $message }}</span>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            @if ($action == 'create')
                                                <a type="button" class="btn btn-success"
                                                    href="{{ route('produksiextruder.laporansulzer.create_laporan', ['tanggal' => $tanggal, 'shift' => $shift, 'mesin_id' => $mesin_id]) }}"><i
                                                        class="fa fa-forward"></i>
                                                    Lanjutkan Buat Laporan</a>
                                            @else
                                                <a type="button" class="btn btn-success"
                                                    href="{{ route('produksiextruder.laporansulzer.edit', $laporansulzer->slug) }}"><i
                                                        class="fa fa-forward"></i>
                                                    Lanjutkan Buat Laporan</a>
                                            @endif
                                        </div>
                            ...
                            <div class="card-footer">
                                <a type="button" class="btn btn-default"
                                    href="{{ route('produksiextruder.laporansulzer.index') }}"><i class="fa fa-reply"></i>
                                    Kembali</a>
                            </div>
                        </div>
                        <!-- /.card -->
