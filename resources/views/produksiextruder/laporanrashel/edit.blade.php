                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('jenis_produksi') ?? $laporanrashel->jenis_produksi }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('meter_awal') ?? $laporanrashel->meter_awal }}">
                                                @error('meter_awal')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('meter_akhir') ?? $laporanrashel->meter_akhir }}">
                                                @error('meter_akhir')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('keterangan_produksi') is-invalid @enderror" rows="5"
                                                    id="keterangan_produksi" name="keterangan_produksi">{!! old('keterangan_produksi') ?? $laporanrashel->keterangan_produksi !!}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('keterangan_mesin') is-invalid @enderror" rows="5" id="keterangan_mesin"
                                                    name="keterangan_mesin">{!! old('keterangan_mesin') ?? $laporanrashel->keterangan_mesin !!}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="div_jam_stop"
                                                    ...
                                                    <input type="text" class="form-control datetimepicker-input"
                                                        ...
                                                        value="{{ old('jam_stop') ?? $laporanrashel->jam_stop }}" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="div_jam_jalan"
                                                    ...
                                                    <input type="text" class="form-control datetimepicker-input"
                                                        ...
                                                        value="{{ old('jam_jalan') ?? $laporanrashel->jam_jalan }}" />
