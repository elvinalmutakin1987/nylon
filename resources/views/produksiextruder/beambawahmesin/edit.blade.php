                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Beam Bawah Mesin</li>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <!-- Application buttons -->
                        <form action="{{ route('produksiextruder.beambawahmesin.update', $beambawahmesin->slug) }}"
                            enctype="multipart/form-data" method="POST">
                            @csrf
                            @method('put')
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Beam Bawah Mesin</h3>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="div_tanggal" data-target-input="nearest">
                                                    <input type="text" class="form-control datetimepicker-input"
                                                        ...
                                                        value="{{ old('tanggal') ?? $beambawahmesin->tanggal }}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select
                                                ...
                                                <option value="{{ $beambawahmesin->beam_number }}">
                                                    {{ $beambawahmesin->beam_number }}</option>
                                            </select>
                                            @error('beam_number')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select
                                                ...
                                                <option value="GCGU/ GCBU"
                                                    {{ $beambawahmesin->jenis_produksi == 'GCGU/ GCBU' ? 'selected' : '' }}>
                                                    GCGU/ GCBU</option>
                                                <option value="Wistaria"
                                                    {{ $beambawahmesin->jenis_produksi == 'Wistaria' ? 'selected' : '' }}>
                                                    Wistaria</option>
                                                <option value="30070i"
                                                    {{ $beambawahmesin->jenis_produksi == '30070i' ? 'selected' : '' }}>
                                                    30070i</option>
                                                <option value="Natalia Phinisi (rajutan 12)"
                                                    {{ $beambawahmesin->jenis_produksi == 'Natalia Phinisi (rajutan 12)' ? 'selected' : '' }}>
                                                    Natalia Phinisi (rajutan 12)</option>
                                                <option value="Natalia Phinisi (rajutan 11)"
                                                    {{ $beambawahmesin->jenis_produksi == 'Natalia Phinisi (rajutan 11)' ? 'selected' : '' }}>
                                                    Natalia Phinisi (rajutan 11)</option>
                                                <option value="Natalia Standard"
                                                    {{ $beambawahmesin->jenis_produksi == 'Natalia Standard' ? 'selected' : '' }}>
                                                    Natalia Standard</option>
                                                <option value="CWU"
                                                    {{ $beambawahmesin->jenis_produksi == 'CWU' ? 'selected' : '' }}>
                                                    CWU</option>
                                                <option value="PWU"
                                                    {{ $beambawahmesin->jenis_produksi == 'PWU' ? 'selected' : '' }}>
                                                    PWU</option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ $beambawahmesin->beam_sisa ? Illuminate\Support\Number::format($beambawahmesin->beam_sisa) : '' }}">
                                            @error('beam_sisa')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('berat') is-invalid @enderror"
                                                ...
                                                value="{{ $beambawahmesin->berat ? Illuminate\Support\Number::format($beambawahmesin->berat) : '' }}">
                                            @error('berat')
                                                <span id="berat-error"
                                                    class="error invalid-feedback">{{ $message }}</span>
                                            @enderror
                                ...
                                <div class="card-footer">
                                    <a type="button" class="btn btn-default"
                                        href="{{ route('produksiextruder.beambawahmesin.index') }}"><i
                                            class="fa fa-reply"></i>
                                        Kembali</a>
    ...
    <script type="text/javascript">
        ...
        function format_select2() {
            $('.select-beam-number').select2({
                ...
                allowClear: true,
                ajax: {
                    url: '{{ route('produksiextruder.beambawahmesin.get_beamnumber') }}',
                    dataType: 'json',
