                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" Active>Beam Bawah Mesin</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Beam Bawah Mesin</h3>
                            </div>
                            <div class="card-body">
                                <div class="row mb-4">
                                    <div class="col-md-12">
                                        <a type="button" class="btn btn-success m-1"
                                            href="{{ route('produksiextruder.beambawahmesin.create') }}"><i
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item"
                                                                    href="{{ route('produksiextruder.beambawahmesin.edit', $d->slug) }}")">
...
@section('script')
    <script type="text/javascript">
        function hapus(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = `{!! route('produksiextruder.beambawahmesin.destroy', ':_id') !!}`;
        ...
        function cetak() {
            var url = "{!! route('produksiextruder.beambawahmesin.cetak') !!}";
            window.open(url, '_blank');
        }

        function export_() {
            var url = "{!! route('produksiextruder.beambawahmesin.export') !!}";
            window.open(url, '_blank');
        }
    </script>
@endsection
