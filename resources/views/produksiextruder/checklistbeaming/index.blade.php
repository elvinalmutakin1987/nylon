                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <button type="button" class="btn btn-success" data-toggle="modal"
                                            data-target="#modal-import" onclick="cek_laporan_rashel()"><i
                                                class="fa fa-plus"></i>
                                            Check List Beaming</button>
                                    </div>
                                </div>
...
@section('script')
    <script type="text/javascript">
        ...
        function cek_laporan_rashel() {
            var url =
                '{!! route('produksiextruder.checklistbeaming.create', [
                    'tanggal' => '_tanggal',
                    'shift' => '_shift',
                    'mesin_id' => '_mesin_id',
                ]) !!}';
