...
@section('script')
    <script type="text/javascript">
        ...
        var ajax = ajax = '{{ url()->current() }}?tanggal_dari=' + $("#tanggal_dari").val() + '&tanggal_sampai=' + $(
            '#tanggal_sampai').val() + '&nama_toko=' + $('#nama_toko').val();
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            if (data == 'Draft') {
                                return '<span class="badge bg-default" style="font-size: 13px">' + data +
                                    '</span>';
                            } else if (data == 'Submit') {
        ...
        $(".select-nama-toko").on('change', function(e) {
            ajax = '{{ url()->current() }}?tanggal_dari=' + $("#tanggal_dari").val() + '&tanggal_sampai=' + $(
                '#tanggal_sampai').val() + '&nama_toko=' + $('#nama_toko').text();
