                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="no_order">No. Surat Jalan</label>
                                            <p>{{ $suratjalan->no_dokumen }}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="nama_pemesan">Nama Toko</label>
                                            <p>{{ $suratjalan->nama_pemesan ?? '-' }}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <p>{{ $suratjalan->no_polisi }}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="sopir">Sopi</label>
                                            <p>{{ $suratjalan->sopir }}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
