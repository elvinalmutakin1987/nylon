        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <!-- Application buttons -->
                        <form action="{{ route('permintaanmaterial.update', $permintaanmaterial->slug) }}"
                            enctype="multipart/form-data" method="POST">
                            @csrf
                            @method('put')
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Permintaan Bahan Baku</h3>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('no_dokumen') ?? $permintaanmaterial->no_dokumen }}" readonly>
                                            @error('no_dokumen')
                                        ...
                                        <div class="form-group table-responsive">
                                            <table id="table1" class="table border table-sm projects">
                                                ...
                                                <tbody>
                                                    @foreach ($permintaanmaterial->permintaanmaterialdetail as $d)
                                                        <tr>
                                                            <td>
                                                                <select class="form-control select2 w-100 select-barang"
                                                                    id="mamterial_id{{ $d->id }}"
                                                                    name="material_id[]">
                                                            ...
                                                            <td>
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value={{ Number::format($d->jumlah) }}>
                                                            </td>
                                                            <td>
                                                                <input type="text" class="form-control"
                                                                    id="keterangan{{ $d->id }}" name="keterangan[]"
                                                                    value="{{ $d->keterangan }}">
                                                            </td>
