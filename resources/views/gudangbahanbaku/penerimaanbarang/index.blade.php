                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row mb-4">
                                    <div class="col-md-12">
                                        <a type="button" class="btn btn-success m-1"
                                            href="{{ route('penerimaanbarang.create') }}"><i class="fa fa-plus"></i> Tambah
                                            Data</a>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-3">
                                        <select class="form-control select2 w-100 select-supplier" id="supplier"
                                            name="supplier">
                                            <option></option>
                                        </select>
                                    </div>
...
@section('script')
    <script type="text/javascript">
        ...
        var ajax = '{{ url()->current() }}?tanggal_dari=' + $("#tanggal_dari").val() + '&tanggal_sampai=' + $(
                '#tanggal_sampai').val() + '&supplier=' + $('#supplier').val() +
            '&status=' + $('#status').val();
        ...
        $(document).ready(function() {
            ...
            $('.select-supplier').select2({
                ...
                allowClear: true,
                ajax: {
                    url: '{{ route('penerimaanbarang.get_supplier') }}',
                    dataType: 'json',
        ...
        function hapus(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = `{!! route('penerimaanbarang.destroy', ':_id') !!}`;
