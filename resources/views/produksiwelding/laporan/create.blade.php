        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <!-- Application buttons -->
                        <form action="{{ route('produksiwelding.laporan.store') }}" enctype="multipart/form-data"
                            method="POST">
                            @csrf
                            @method('post')
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Tambah Produksi Welding</h3>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                                ...
                                                <table id="table1" class="table table-bordered table-sm">
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th id="grand_total" class="text-center"></th>
                                                            <th colspan="2"></th>
                                                        </tr>
                                                    </thead>
                                                </table>
