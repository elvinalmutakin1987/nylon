...
@section('content')
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row mb-4">
                                    <div class="col-md-12">
                                        <a type="button" class="btn btn-success m-1" href="{{ route('lokasi.create') }}"><i
                                                class="fa fa-plus"></i> Tambah
                                            Data</a>
                                        <a type="button" class="btn btn-default m-1" id="button-export"
                                            href="{{ route('lokasi.export') }}"><i class="fa fa-upload"></i> Export</a>
    ...
    <form enctype="multipart/form-data" id="form-import" method="POST" action="{{ route('lokasi.import') }}">
